...
export default function TaskComponent({ toDoTasks, setToDoTasks }) {
        ...
        </Box>
        {
          ...
          <Box display="flex" flexWrap="wrap">
          {
            toDoTasks.map((task,index)=>(
              <Tasks task={task} index={index} toDoTasks={toDoTasks} setToDoTasks={setToDoTasks} subTask={subTask} setSubTask={setSubTask} color={colors[index%4]} />
            ))
          }      
        </Box>
        }
